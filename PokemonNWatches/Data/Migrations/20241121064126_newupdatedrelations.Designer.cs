...
namespace PokemonNWatches.Data.Migrations
{
    ...
    [Migration("20241121064126_newupdatedrelations")]
    partial class newupdatedrelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuildHeldItem", b =>
                {
                    b.HasOne("PokemonNWatches.Models.Build", null)
                        .WithMany()
                        .HasForeignKey("BuildsBuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PokemonNWatches.Models.HeldItem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HeldItemPokemon", b =>
                {
                    ...
                    b.HasOne("PokemonNWatches.Models.Pokemon", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PokemonNWatches.Models.Build", b =>
                {
                    b.HasOne("PokemonNWatches.Models.Pokemon", "Pokemon")
                        .WithMany("Builds")
